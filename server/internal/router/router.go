...
func New(cfg config.Config, db *gorm.DB) *gin.Engine {
	...
	publicAuth.GET("/captcha", homeAuth.Captcha)
	publicAuth.POST("/register", homeAuth.Register)
	publicAuth.POST("/login", homeAuth.Login)
	publicAuth.POST("/email-code", homeAuth.SendEmailCode)
	publicAuth.POST("/reset-password", homeAuth.ResetPassword)
	publicAuth.GET("/:provider", homeAuth.OAuthRedirect)
	publicAuth.GET("/:provider/callback", homeAuth.OAuthCallback)
